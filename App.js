...
import { Container, Text, StyleProvider, Header, Left, Right, Body, Title, Button, Spinner, Icon } from 'native-base';
...
export default class App extends React.Component { 
  ...
  render () {
    if (!this.state.isReady) return (<Container style={styles.container}><Spinner/></Container>)
    return (
